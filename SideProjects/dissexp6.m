function results = dissexp6(input)
...
%%%%%%%%%%%%%%%%%%%%%
%%%%	weighted score based fusion - Miller dissertation patches - Miller disseration feature extraction method for trained classifier - on periocular using FRGC data
%%%%%%%%%%%%%%%%%%%%%
	...
	%features = load([experiment.output.resultsdir experiment.HOG8 experiment.output.gallery_mat], 'features');	gf2 = features.features;
	...
	%features = load([experiment.output.resultsdir experiment.HOG8 experiment.output.probe_mat], 'features');  pf2 = features.features;
	...
	for k=1:2
		for j=1:7
			...
			fprintf('[%6.2f s][k=%d][j=%d] %3.2f %3.2f %3.2f %3.2f %3.2f %3.2f %3.2f \n',time,k,j,weights)
		end
	end
