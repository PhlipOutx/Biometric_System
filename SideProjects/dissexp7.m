function results = dissexp7(input)
...
%%%%%%%%%%%%%%%%%%%%%
%%%%	unweighted score based fusion selection - Miller dissertation patches - Miller disseration feature extraction method for untrained classifier - on periocular using FRGC data
%%%%%%%%%%%%%%%%%%%%%
	...
	for k=1:2
		for i=1:7
			...
			for j=1:4
				...
				%score = ROC_rates_and_threshs.VER_01FAR_ver*100;
