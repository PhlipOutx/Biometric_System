function results = dissexp4(input)
...
%%%%%%%%%%%%%%%%%%%%%
%%%%	unweighted feature based fusion - Miller dissertation patches - Miller disseration feature extraction method for trained classifier - on periocular using FRGC data
%%%%%%%%%%%%%%%%%%%%%
