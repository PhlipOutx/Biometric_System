function results = dissexp2(input)
...
%%%%%%%%%%%%%%%%%%%%%
	...
	i=3;j=4;
	gallery_features =  [gallery_features; gf4(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	probe_features =  [probe_features; pf4(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	i=4;j=4;
	gallery_features =  [gallery_features; gf4(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	probe_features =  [probe_features; pf4(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	i=5;j=3;
	...
	i=6;j=2;
	gallery_features =  [gallery_features; gf2(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	probe_features =  [probe_features; pf2(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	i=7;j=2;
	gallery_features =  [gallery_features; gf2(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	probe_features =  [probe_features; pf2(((loc(i,1)-1)*flength(j))+1:loc(i,2)*flength(j),:)];
	i=8;j=3;
