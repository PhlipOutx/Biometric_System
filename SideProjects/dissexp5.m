function results = dissexp5(input)
...
%%%%%%%%%%%%%%%%%%%%%
%%%%	weighted score based fusion - Miller dissertation patches - Miller disseration feature extraction method for untrained classifier - on periocular using FRGC data
%%%%%%%%%%%%%%%%%%%%%
